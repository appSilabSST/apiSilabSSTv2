    ...
    try {
        ...
        if (isset($_GET["id"]) && is_numeric($_GET["id"])) {
            ...
            $sql = "
				...
				pf.nome AS nome_profissional,pf.numero,pf.estado,esp.siglas as orgao_profissional,
                ...
                LEFT JOIN especialidades esp ON (esp.id_especialidade = pf.id_especialidade)          
