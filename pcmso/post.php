...
if ($authorization) {
    try {
        if (
            ...
            $sql = "
            INSERT INTO pcmso (nr_pcmso, id_profissional,id_usuario, data_inicio, id_empresa, id_local_atividade, id_empresa_local_atividade,grau_risco_empresa, grau_risco_local_atividade, responsavel, responsavel_cpf, responsavel_email, consideracoes_finais,relatorio_analitico) 
            SELECT 
            ...
            ),:id_profissional,:id_usuario, :data_inicio, :id_empresa, :id_local_atividade, :id_empresa_local_atividade,:grau_risco_empresa, :grau_risco_local_atividade, :responsavel, :responsavel_cpf, :responsavel_email, :consideracoes_finais,:relatorio_analitico";
