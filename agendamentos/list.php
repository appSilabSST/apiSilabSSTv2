...
if ($postjson['requisicao'] == 'listar') {
    ...
    $sql = "
        SELECT a.id_agendamento, a.id_rl_colaborador_empresa, a.nr_agendamento, a.data, DATE_FORMAT(a.data, '%d/%m/%Y') data_format, a.horario, DATE_FORMAT(a.horario, '%H:%i') horario_format, 
