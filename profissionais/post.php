...
if ($authorization) {
    try {
        if (isset($json['nome']) && isset($json['cpf']) && isset($json['id_especialidade'])) {
            ...
            $sql = "
            INSERT INTO profissionais (nome, cpf, id_especialidade, orgao_classe, orgao_nr, orgao_uf, nit) VALUES
            (:nome, :cpf, :id_especialidade, :orgao_classe, :orgao_nr, :orgao_uf, :nit)
            ";
