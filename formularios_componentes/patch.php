...
if ($authorization) {
    try {
        if (isset($json['id']) && is_numeric($json['id'])) {
            $sql = "UPDATE rl_formularios_componentes SET ";
            $params = [];
            ...
            $sql = rtrim($sql, ', ') . " WHERE id_rl_formulario_componente = :id_rl_formulario_componente";
            $params[':id_rl_formulario_componente'] = $json['id'];
